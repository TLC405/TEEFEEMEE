    ...
    return (
        <div className="w-full flex flex-col items-center">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full mt-4">
                ...
                <div className="simpson-panel p-4 animate-pop-in flex flex-col">
                ...
                {/* Controls Column */}
                <div className="simpson-panel p-4 animate-pop-in flex flex-col justify-between" style={{ animationDelay: '100ms' }}>
                    <ThemeSelector themes={themes} onThemeSelect={onThemeSelect} isLoading={isLoading} selectedTheme={selectedTheme} onRandomThemeSelect={onRandomThemeSelect} />
                ...
                {/* Result Display */}
                <div className="simpson-panel p-4 animate-pop-in flex flex-col" style={{ animationDelay: '200ms' }}>
